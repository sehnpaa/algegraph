...
/* package algegraph-0.1.0.0 */
#define VERSION_algegraph "0.1.0.0"
#define MIN_VERSION_algegraph(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package algebraic-graphs-0.0.5 */
#define VERSION_algebraic_graphs "0.0.5"
...
#define CURRENT_COMPONENT_ID "algegraph-0.1.0.0"

#define CURRENT_PACKAGE_KEY "algegraph-0.1.0.0"
